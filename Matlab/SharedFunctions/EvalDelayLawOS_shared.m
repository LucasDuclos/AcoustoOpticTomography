...
% (X0,Z0) : image of X_m using the DelayLAWS inpout at t=0
...
% initialization:
angle = zeros(1,Nangle); % angle emission of wavefront initialization
M0    = zeros(Nangle,2); % initial position of wavefront initialization
C     = zeros(Nangle,2);
...
if ScreenResult ==1
  ...
  subplot(211)
    ...
    for i = 1:Nangle     
       ...
       % truncation of angle by 6 unit decimate to prevent matching
       % errors:
