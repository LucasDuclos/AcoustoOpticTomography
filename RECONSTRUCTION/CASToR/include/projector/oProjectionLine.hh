...
class oProjectionLine
{
  ...
  public:
    ...
    */
    ...
    /*!
      \fn      public void oProjectionLine::AddLine()
      \param   int a_direction
      \param   int a_nbTOFBins
      \param   FLTNB** a2p_voxelWeights
      \brief   This function is used to add a line, when computation strategy is image computation strategy
    */
    void AddLine(int a_direction, int a_nbTOFBins, char* a2p_voxelWeights);
    /*!
