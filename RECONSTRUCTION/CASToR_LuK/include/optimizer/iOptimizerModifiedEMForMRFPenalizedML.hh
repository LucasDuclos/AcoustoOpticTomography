...
// This optimizer is only compatible with quadratic MRF
...
class iOptimizerModifiedEMForMRFPenalizedML : public vOptimizer
{
  ...
  private:
    ...
    FLTNB* mp_sumOfWeightsImage;           /*!< Image containing the sum of weights of neighboring voxels contributing to the smoothed image */
};
