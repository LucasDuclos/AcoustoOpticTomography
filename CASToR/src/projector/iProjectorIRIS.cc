...
int iProjectorIRIS::ProjectTOFListmode(int a_Projector, oProjectionLine* ap_ProjectionLine)
{
  Cerr("***** iProjectorIRIS::ProjectTOFListmode() -> Not yet implemented !" << endl);
  return 1;
}
...
int iProjectorIRIS::ProjectTOFHistogram(int a_Projector, oProjectionLine* ap_ProjectionLine)
{
  Cerr("***** iProjectorIRIS::ProjectTOFHistogram() -> Not yet implemented !" << endl);
  return 1;
}
