...
class oProjectorManager
{
  ...
  public:
    ...
    */
    ...
    /*!
      \fn      public inline void oProjectorManager::SetPathToSystemMatrixDirectory()
      \param   SetPathToSystemMatrixDirectory(const string& a_path)
      \brief   Set the path to the directory containing the system matrix
    */
    inline void SetPathToSystemMatrixDirectory(const string& a_path)
           {m_pathToSystemMatrixDirectory = a_path;}
    /*!
  ...
  private:
    ...
    string m_pathToSystemMatrixDirectory;	/*!< The path to the directory where the system matrix is stored */
